...
SB_SIGNING_UTILS_VERSION ?= 5c71ba622371c26226959904ca34a198d2b2dd15
...
SB_SIGNING_UTILS_KEY_V3_SRC_PATH=$(BR2_EXTERNAL)/package/sb-signing-utils/v3_keys
SB_SIGNING_UTILS_KEY_V3_DST_PATH=$(HOST_DIR)/etc/v3_keys
...
define HOST_SB_SIGNING_UTILS_COPY_KEYS
	...
	$(INSTALL) -d -m 0755 $(SB_SIGNING_UTILS_KEY_V3_DST_PATH)
	$(INSTALL) -m 0755 $(SB_SIGNING_UTILS_KEY_V3_SRC_PATH)/* \
		$(SB_SIGNING_UTILS_KEY_V3_DST_PATH)
endef
